...
- **Faster than v2.5** - Nearly 40% faster than EasyAI v2.5, and can be even faster if you enable xFormers.
...
- **Name change** - Last, and probably the least, the UI is now called "EasyAI". It indicates the focus of this project - an easy way for people to play with Stable Diffusion.
...
* 2.5.42 - 26 Jun 2023 - Use YAML files for config. You can now edit the `config.yaml` file (using a text editor, like Notepad). This file is present inside the EasyAI folder, and is easier to read and edit (for humans) than JSON. Thanks @JeLuf.
...
* 2.5.41 - 5 Jun 2023 - Allow sharing an EasyAI instance via https://try.cloudflare.com/ . You can find this option at the bottom of the Settings tab. Thanks @JeLuf.
* 2.5.41 - 5 Jun 2023 - Show an option to download for tiled images. Shows a button on the generated image. Creates larger images by tiling them with the image generated by EasyAI. Thanks @JeLuf.
...
* 2.5.40 - 3 Jun 2023 - Added CodeFormer as another option for fixing faces and eyes. CodeFormer tends to perform better than GFPGAN for many images. Thanks @patriceac for the implementation, and for contacting the CodeFormer team (who were supportive of it being integrated into EasyAI).
